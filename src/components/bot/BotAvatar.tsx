...
function Wren() {
  ...
  return (
    <>
      <Shoulders shirt={p.shirt} />
      {/* bob behind the face */}
      <path d="M18.5 24 Q18.5 12.5 32 12.5 Q45.5 12.5 45.5 24 L45.5 36 Q45.5 41 41.5 42 L41.5 30 L22.5 30 L22.5 42 Q18.5 41 18.5 36Z" fill={p.hair} />
      <Head p={p} />
      {/* straight fringe */}
      <path d="M20 27 Q20 15 32 15 Q44 15 44 27 L41 27 Q41.5 21 38 19.5 L38.5 25 L34 20 L32.5 25 L28 19.8 L27 25.5 L23.5 21 Q22 24 23 27Z" fill={p.hair} />
      <Glasses round />
      <Eyes />
      <Smile w={5} />
    </>
